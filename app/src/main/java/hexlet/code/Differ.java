...
public class Differ {
    public static String generate(String filePath1, String filePath2) throws Exception {
        String readContent1 = Files.readString(Paths.get(filePath1));
        String readContent2 = Files.readString(Paths.get(filePath2));
        ObjectMapper objectMapper = new ObjectMapper();
        Map<String, Object> map1 = objectMapper.readValue(readContent1, Map.class);
        Map<String, Object> map2 = objectMapper.readValue(readContent2, Map.class);
